export default function Footer() {
    return (
      <div className="inline-flex sm:flex flex-col items-center gap-[20px] sm:gap-[10px] px-[65px] py-[25px] border-t-[1px] sm:h-[190px] ">
        <div className="content flex-col sm:flex-row flex gap-[20px] sm:gap-[15px] items-start ">
          ...
          <div className="flex sm:justify-center items-start gap-[60px]">
            <div className="flex flex-col items-start gap-[18px]">
              <h3 className="text-[16px] font-semibold leading-[21px]">
                Тусламж
              </h3>
              <div className="flex flex-col items-start gap-[6px]">
                <a href="" className="text-[14px] leading-[18px]">
                  Хэрэглэх заавар
                </a>
                <a href="" className="text-[14px] leading-[18px]">
                  Санал хүсэлт
