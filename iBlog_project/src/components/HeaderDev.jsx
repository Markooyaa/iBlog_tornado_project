    ...
    return (
        ...
        <div id="computer" class=" hidden lg:flex lg:logo  lg:h-[46px] lg:justify-between lg:mx-[50px] lg:items-center lg:my-[20px]">
                ...
                <div class="relative search">
                    ...
                    <svg class="absolute right-2 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path d="M21 21l-6-6M3 12a9 9 0 1118 0 9 9 0 01-18 0z"></path>
                    </svg>
                
                  </div>
                  <div class="Buttons">
                    <button class="text-[#E86B02] border border-[#DCE3EA] rounded-lg pl-4 pr-4 py-[10px]  mr-[10px] pr-[30px] pl-[30px]" onclick={clickHandler}>
                        Бүртгүүлэх
                    </button>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
                    <button class="text-white bg-[#E86B02] rounded-lg pl-4 pr-4 py-[10px] pr-[30px] pl-[30px]" onClick={clickHandler}>
                        Нэвтрэх
                    </button>
                  </div>
            </div>
