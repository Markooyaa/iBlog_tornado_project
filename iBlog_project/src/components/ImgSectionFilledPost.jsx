  ...
  return (
    <>
      ...
      <div class="img-section h-[154px] w-full p-[2px] flex justify-center rounded-xl mt-[10px] mb-[20px] relative">
        ...
        <div class="flex items-center justify-center absolute gap-1 top-1/2">
          <a
            href=""
            class="text-white text-[14px] underline underline-offset-2">
            picture.01.png
          </a>
          <svg
            ...
            viewBox="0 0 12 12"
            fill="none"
            class="p-[1px] rounded-full border border-white">
            <path
              d="M9 3L3 9M3 3L9 9"
              stroke="white"
