  ...
  return (
    <div className="relative   flex flex-col flex-wrap gap-[16px] w-full">
      ...
      <FaChevronLeft
        ...
        className={`text-[#546371] p-[15px] shadow-black shadow-2xl absolute left-5  w-[52px] h-[52px] rounded-full hidden  bg-white ${arrowDisable==true?'':'sm:flex'} `}
      ...
      <FaChevronRight
         ...
         className="text-[#546371] p-[15px] shadow-black shadow-2xl absolute right-5 hidden    w-[52px] h-[52px] rounded-full  bg-white  sm:flex"
        />
