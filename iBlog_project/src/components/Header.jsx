...
export default function HeaderComponent({uid}) {
  ...
  const [dialog, setDialog] = useState(false)
    ...
    return (
            <div className="hidden h-[103px] max-w-full sm:flex px-12 py-10 justify-between items-center    border-b-[1px]">
                ...
                {uid==false?<div className="flex justify-end items-start ">
                ...
                </div>:<div className="Buttons sm:flex hidden gap-2">
                <Link to={'/likedposts'}>
                <svg
                ...
                <button
                    ...
                    {dialog ?
                        <div id="dialogContainer"  className=" fixed inset-0 z-50  flex items-center justify-center bg-gray-900 bg-opacity-50 " onClick={Dialog}>
                            <div className="bg-white rounded-md p-4 flex flex-col justify-center w-[482px]">
                                <div className="w-full justify-end flex   ">
                                    <button className="rounded-full border p-[3px]" onClick={Dialog}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path d="M15 5L5 15M5 5L15 15" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </button>
                                </div>
                                ...
                                <div className="flex gap-[15px]">
                                    <button onClick={handleLogout} className=" text-center text-white bg-[#E86B02] lg:rounded-lg rounded-2xl pl-4 pr-4 py-[10px] pr-[30px] pl-[30px] w-[50%]   h-[50px] my-[12px]">
                                        Тийм
                                    </button>
